...
def ensure_indexes() -> None:
    ...
    db.trend_feedback.create_index([("creator_id", 1), ("created_at", -1)])
    db.trend_feedback.create_index([("creator_id", 1), ("trend_id", 1)])
    db.creator_weights.create_index("creator_id", unique=True)
